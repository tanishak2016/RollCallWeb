#pragma checksum "G:\RollCallWeb\Areas\RollCall\Views\Candidate\cylender.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "f73c73420feb844eead6547c9d9789914e682d5f"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"f73c73420feb844eead6547c9d9789914e682d5f", @"/Areas/RollCall/Views/Candidate/cylender.cshtml")]
...
#nullable disable
        ...
        function DrawPieChart(series) {            
            ...
            WriteLiteral(@"     plotBackgroundColor: null,
                ...
                xAxis: {
                   categories: [""FPReaderID"", ""QRCodeValid"",""FaceVerified""] ,                   
                    crosshair: true
                },
                ...
                tooltip: {
                    ...
                    pointFormat: '<tr href=""#"">' + '<td style=""padding:0;color:red""><b> {point.percentage:.1f}% </b></td></tr>',
                    footerFormat: '</table>'
                },
                plotOptions: {
                   column: {
            ...
            WriteLiteral(@"bels: {
                            enabled: true,
                            format: '<span style=color:red;font-size:13px>{point.name}: {point.y}</span>',
    ...
    //                top: '18px',
    //                color: ( // theme
    //                    Highcharts.defaultOptions.titl");
            WriteLiteral(@"e.style &&
    ...
    //            y: 13,
    //            color: Highcharts");
            WriteLiteral(@".getOptions().colors[0] // Jane's color
    //        }, {
    //            name: 'John',
    //            y: 23,

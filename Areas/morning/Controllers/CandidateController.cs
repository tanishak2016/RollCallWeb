...
using RollCall.Areas.morning.Models;
using System;
...
using static RollCall.Areas.morning.Models.DataTableHelper;
using RollCall.Areas.morning.Data;

namespace RollCall.Areas.morning.Controllers
{
    [Area("morning")]
    public class CandidateController : Controller
    {
      ...
      //  DAL dal = new DAL();
        ...
        [HttpPost]
        public ActionResult pie(BarProperties  param)
        {
            List<pieProperties> pieData = new List<pieProperties>();
